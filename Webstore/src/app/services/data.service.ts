...
export class DataService {
  ...
  products: AProduct[] = [
    ...
    },
    {
      id: '31',
      name: 'Couscous',
      description: 'Small, fluffy, and tasty Semolina Wheat Pasta of North African origin, perfect side dish to meat, poultry, or fish 100% natural, cholesterol free, sodium free, saturated fat free',
      category: 'Grain',
      price: '5.00',
    ...
    {
      id: '32',
      name: 'Fufu Flour Cocoyam',
      description: 'FUFU Flour Cocoyam',
      category: 'Grain',
      price: '6.00',
